      ...
      <div className="routes py-10 grid grid-cols-2">
        <div className="rout1 sm:col-span-1 col-span-2 mx-10">
          <div className="flex align-middle items-center justify-between py-5 text">
            ...
            <p className="border border-[#EE6C4D] p-2 rounded-md px-6 text-[#EE6C4D] hover:text-[#FFFFFF] hover:bg-[#EE6C4D]">
              11:00
            </p>
          </div>
        ...
        <div className="rout2 sm:col-span-1 col-span-2  mx-10">
          <div className="flex align-middle items-center justify-between py-5 text">
            <p className="text-slate-700">Lahore To Multan</p>
            <button className="border border-[#EE6C4D] p-2 rounded-md px-6 text-[#EE6C4D] hover:text-[#FFFFFF] hover:bg-[#EE6C4D]">
              Book Now
            </button>
          </div>
          <hr className="border-slate-400" />
        ...
        <div className="rout5 sm:col-span-1 col-span-2  mx-10">
          <div className="flex align-middle items-center justify-between py-5 text">
            <p className="text-slate-700">Bahawalpur To Lahore</p>
            <button className="border border-[#EE6C4D] p-2 rounded-md px-6 text-[#EE6C4D] hover:text-[#FFFFFF] hover:bg-[#EE6C4D]">
              Book Now
            </button>
          </div>
